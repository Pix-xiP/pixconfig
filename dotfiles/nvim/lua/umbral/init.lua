-- Name:         Umbral
-- Description:  Deep mystical vibes with cold elements and void colouring
-- Author:       Pix
-- Maintainer:   Pix
-- License:      MIT
-- Last Updated: 2025
...
-- end
-- Umbral Theme for Neovim
-- Inspired by cosmic imagery with deep blues, purples and pink accents
...
local colors = {
	void_black = "#0A0214",
	midnight_blue = "#0C1035",
	astral_indigo = "#1D1E4A",
	nebula_purple = "#271754",
	twilight_blue = "#24366C",
	cosmic_blue = "#324890",
	faded_violet = "#4A3A78",
	deep_magenta = "#562C5F",
	nova_pink = "#DE3E91",
	rose_mist = "#FF6CAC",
	dusk_purple = "#9971C1",
	celestial_lavender = "#B99DE1",
	star_white = "#E9E1FF",
	solar_yellow = "#FFD369",
	ember_orange = "#FF7057",
	azure_highlight = "#54C8FF",
}

-- Terminal Colors
local terminal_colors = {
	[0] = colors.void_black, -- Black
	[1] = colors.deep_magenta, -- Red
	[2] = colors.twilight_blue, -- Green
	[3] = colors.dusk_purple, -- Yellow
	[4] = colors.astral_indigo, -- Blue
	[5] = colors.nebula_purple, -- Magenta
	[6] = colors.cosmic_blue, -- Cyan
	[7] = colors.celestial_lavender, -- White
	[8] = colors.midnight_blue, -- Bright Black
	[9] = colors.nova_pink, -- Bright Red
	[10] = colors.azure_highlight, -- Bright Green
	[11] = colors.solar_yellow, -- Bright Yellow
	[12] = colors.faded_violet, -- Bright Blue
	[13] = colors.rose_mist, -- Bright Magenta
	[14] = colors.ember_orange, -- Bright Cyan
	[15] = colors.star_white, -- Bright White
}
...
function M.setup()
	...
	local groups = {
		-- Editor highlights
		Normal = { fg = colors.star_white, bg = colors.void_black },
		NormalFloat = { fg = colors.star_white, bg = colors.midnight_blue },
		Cursor = { fg = colors.void_black, bg = colors.nova_pink },
		CursorLine = { bg = colors.midnight_blue },
		CursorLineNr = { fg = colors.rose_mist, bold = true },
		LineNr = { fg = colors.faded_violet },
		SignColumn = { bg = colors.void_black },
		ColorColumn = { bg = colors.midnight_blue },
		VertSplit = { fg = colors.nebula_purple },
		MatchParen = { fg = colors.nova_pink, bg = colors.nebula_purple, bold = true },
		StatusLine = { fg = colors.star_white, bg = colors.astral_indigo },
		StatusLineNC = { fg = colors.celestial_lavender, bg = colors.midnight_blue },
		Search = { fg = colors.void_black, bg = colors.solar_yellow },
		IncSearch = { fg = colors.void_black, bg = colors.nova_pink },
		Folded = { fg = colors.celestial_lavender, bg = colors.astral_indigo },
		FoldColumn = { fg = colors.celestial_lavender, bg = colors.void_black },

		-- Popup Menu
		Pmenu = { fg = colors.celestial_lavender, bg = colors.midnight_blue },
		PmenuSel = { fg = colors.star_white, bg = colors.nebula_purple },
		PmenuSbar = { bg = colors.astral_indigo },
		PmenuThumb = { bg = colors.faded_violet },

		-- Tabs
		TabLine = { fg = colors.celestial_lavender, bg = colors.midnight_blue },
		TabLineFill = { bg = colors.void_black },
		TabLineSel = { fg = colors.star_white, bg = colors.nebula_purple, bold = true },

		-- Basic syntax
		Comment = { fg = colors.faded_violet, italic = true },
		Title = { fg = colors.nova_pink, bold = true },
		String = { fg = colors.celestial_lavender },
		Number = { fg = colors.solar_yellow },
		Boolean = { fg = colors.ember_orange },
		Float = { fg = colors.solar_yellow },
		Identifier = { fg = colors.dusk_purple },
		Function = { fg = colors.rose_mist },
		Statement = { fg = colors.nova_pink },
		Conditional = { fg = colors.nova_pink },
		Repeat = { fg = colors.nova_pink },
		Label = { fg = colors.azure_highlight },
		Operator = { fg = colors.celestial_lavender },
		Keyword = { fg = colors.nova_pink },
		Exception = { fg = colors.ember_orange },
		PreProc = { fg = colors.solar_yellow },
		Include = { fg = colors.nova_pink },
		Define = { fg = colors.nova_pink },
		Macro = { fg = colors.ember_orange },
		Type = { fg = colors.azure_highlight },
		Structure = { fg = colors.azure_highlight },
		Special = { fg = colors.cosmic_blue },
		Underlined = { fg = colors.azure_highlight, underline = true },
		Error = { fg = colors.star_white, bg = colors.deep_magenta },
		Todo = { fg = colors.void_black, bg = colors.solar_yellow, bold = true },

		-- Diff
		DiffAdd = { fg = colors.void_black, bg = colors.cosmic_blue },
		DiffChange = { fg = colors.void_black, bg = colors.dusk_purple },
		DiffDelete = { fg = colors.void_black, bg = colors.deep_magenta },
		DiffText = { fg = colors.void_black, bg = colors.nova_pink },

		-- Git signs
		GitSignsAdd = { fg = colors.cosmic_blue },
		GitSignsChange = { fg = colors.dusk_purple },
		GitSignsDelete = { fg = colors.deep_magenta },

		-- LSP
		DiagnosticError = { fg = colors.nova_pink },
		DiagnosticWarn = { fg = colors.solar_yellow },
		DiagnosticInfo = { fg = colors.azure_highlight },
		DiagnosticHint = { fg = colors.faded_violet },

		-- Treesitter
		["@variable"] = { fg = colors.star_white },
		["@function"] = { fg = colors.rose_mist },
		["@function.builtin"] = { fg = colors.rose_mist },
		["@keyword"] = { fg = colors.nova_pink },
		["@keyword.function"] = { fg = colors.nova_pink },
		["@keyword.operator"] = { fg = colors.celestial_lavender },
		["@method"] = { fg = colors.rose_mist },
		["@property"] = { fg = colors.celestial_lavender },
		["@parameter"] = { fg = colors.dusk_purple },
		["@string"] = { fg = colors.celestial_lavender },
		["@string.regex"] = { fg = colors.solar_yellow },
		["@type"] = { fg = colors.azure_highlight },
		["@type.builtin"] = { fg = colors.azure_highlight },
		["@constant"] = { fg = colors.cosmic_blue },
		["@constant.builtin"] = { fg = colors.cosmic_blue },
		["@field"] = { fg = colors.celestial_lavender },
		["@constructor"] = { fg = colors.azure_highlight },
		["@attribute"] = { fg = colors.ember_orange },
		["@tag"] = { fg = colors.nova_pink },
		["@tag.attribute"] = { fg = colors.ember_orange },
		["@text"] = { fg = colors.star_white },
		["@comment"] = { fg = colors.faded_violet, italic = true },
	}
